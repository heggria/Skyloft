    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex">
          ...
          <div className="p-4">
            ...
            <div className="space-y-3">
              ...
              {locations.map((location, index) => (
                <div
                  key={index}
                  className="p-3 rounded-lg border hover:border-primary hover:shadow-md transition-all cursor-pointer"
                >
        ...
        <main className="flex-1 relative">
          <MapComponent locations={locations} onAddLocation={setLocations} />
        </main>
      </div>
    </div>
  );
